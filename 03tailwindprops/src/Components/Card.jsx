...
function Card({username}) {
    ...
    return (
        <div className="flex p-6 font-mono bg-slate-100">
            ...
            <form className="flex-auto pl-6">
                ...
                <div className="flex space-x-2 mb-4 text-sm font-medium">
                    ...
                    <button className="flex-none flex items-center justify-center w-12 h-12 text-white" type="button" aria-label="Like">
